...
// void * listar_numero (int *x[], int qtde, int i);
int position_editor (int x, int edit_position);

int main(){

    int i, cont = -1, regras_quebradas = 0, soma = 0, qtde = 0, cont_numeros = 0;
    int x[100], maior = -1, menor = 101, divisor, primo = 0, edit_position;
    ...
    do {
        ...
        scanf("%d", &option);
        switch (option){
            case 1:                                        //Inserir numeros
                printf("Quantos numeros deseja cadastrar: ");
                scanf(" %d", &cont_numeros);
                for (i = 0; i < cont_numeros; i++){
                    printf("Digite um numero: ");
                    scanf(" %d", &x[qtde]);
                }
                break;

            case 2:                                        //Listar numeros
                // listar_numero (x[i], qtde, i);
                break;

            case 3:                                         //Editar posicao
                printf("Qual posicao deseja editar? ");
                scanf("%d", &edit_position);
                break;
            
            case 4:                                         //Excluir posicao 
                printf("Maior numero digitado: %d \n", maior);
                break;

            case 5:                                         //Listar numeros maior que media
...
void menu (){
    ...
    printf("|   5 - Listar numeros maior que media  | \n");
    printf("|   6 - Sair                            | \n");
    printf("|---------------------------------------| \n");
